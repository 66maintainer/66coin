...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("66");
    case mBTC: return QString("m66");
    case uBTC: return QString::fromUtf8("μ66");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("66");
    case mBTC: return QString("Milli-66 (1 / 1,000)");
    case uBTC: return QString("Micro-66 (1 / 1,000,000)");
